...
keys = [
    ...
    Key(["shift"], "f", lazy.spawn("/home/gabriel/.config/Scripts/rofi/rofi-files"), desc="rofi-files"),
    ...
    Key(["shift"], "p", lazy.spawn("/home/gabriel/.config/Scripts/rofi/srcscript-rofi"), desc="source scripts"),
    Key(["shift"], "s", lazy.spawn("/home/gabriel/.config/Scripts/screenshot"), desc="take screenshots"),
    Key(["shift"], "x", lazy.spawn("/home/gabriel/.config/Scripts/rofi/power-menu.sh"), desc="power-menu"),
    Key([mod], "p", lazy.spawn("rofi -show drun -display-drun ' Exec ' ")),
